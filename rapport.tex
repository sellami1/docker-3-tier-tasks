...
\textbf{Pourquoi StatefulSet ?} MongoDB nécessite un identité réseau stable, un stockage persistant qui suit le pod, et un ordre de déploiement garanti.
...
\item Rejoint du cluster après changement de sous-réseau (token, réinstallation agents)
